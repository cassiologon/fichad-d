...
export const uniqueAdvantages = [
  ...
  { 
    ...
    discountedAdvantages: [
      { name: 'Magia Elemental', cost: 1 }
    ]
  },
  { 
    name: 'Elfo Negro', 
    ...
    freeAdvantages: [
      { type: 'choice', options: ['Magia Branca', 'Magia Negra'] }
    ]
  },
  { 
    name: 'Gnomo', 
  ...
  { 
    ...
    attributeBonuses: {
      caracteristica: 1  // Jogador escolhe qual atributo
    },
    ...
    bonusAdvantage: true // Vantagem bônus especial: uma vantagem de 1 ponto grátis OU uma de 2 pontos por 1 ponto (exceto perícias)
  },
  { 
    name: 'Anfíbio', 
    cost: 0, 
  ...
  { 
    ...
    attributeBonuses: {
      forca: 1,
      habilidade: { value: 1, condition: 'corrida' }  // Bônus condicional apenas para corrida
    },
  ...
  { 
    ...
    discountedAdvantages: [
      { name: 'Magia Branca', cost: 3 },
      { name: 'Magia Elemental', cost: 3 },
      { name: 'Magia Negra', cost: 3 }
    ]
  },
  { 
    name: 'Kemono', 
  ...
  { 
    ...
    freeAdvantages: [
      { type: 'choice', options: ['Magia Branca', 'Magia Elemental', 'Magia Negra'] }
    ]
  },
  { 
    name: 'Nanomorfo', 
  ...
  { 
    ...
    discountedAdvantages: [
      { name: 'Invisibilidade', cost: 1 },
      { name: 'Possessão', cost: 1 }
    ]
  },
  { 
    name: 'Múmia', 
